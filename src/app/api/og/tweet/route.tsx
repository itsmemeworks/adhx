  ...
  if (!tweet) {
    return new ImageResponse(
      ...
      >
        ...
        />
        <div style={{ fontSize: 48, fontWeight: 700, color: 'white', marginBottom: 12 }}>ADHX</div>
        <div style={{ fontSize: 24, color: '#8B5CF6' }}>Save @{username}&apos;s tweet</div>
      </div>,
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: 40 }}>
        ...
        />
        <span style={{ fontSize: 28, fontWeight: 700, color: 'white', marginLeft: 12 }}>ADHX</span>

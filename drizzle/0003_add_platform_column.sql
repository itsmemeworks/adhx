...
--> statement-breakpoint
INSERT INTO `__new_bookmark_tags`("user_id", "platform", "bookmark_id", "tag") SELECT "user_id", "platform", "bookmark_id", "tag" FROM `bookmark_tags`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_collection_tweets`("user_id", "collection_id", "platform", "bookmark_id", "added_at", "notes") SELECT "user_id", "collection_id", "platform", "bookmark_id", "added_at", "notes" FROM `collection_tweets`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_read_status`("user_id", "platform", "bookmark_id", "read_at") SELECT "user_id", "platform", "bookmark_id", "read_at" FROM `read_status`;--> statement-breakpoint
